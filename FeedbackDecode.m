...
if ~isempty(SS.AvailNeural)
    ...
    xippmex_1_12('signal',SS.AvailNeural,'spk',zeros(length(SS.AvailNeural),1)); pause(5); %all available channels need to be sent to xippmex
