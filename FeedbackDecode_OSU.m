function FeedbackDecode_OSU(LabviewIP)
        ...
        switch MLAuxCell{1}
            ...
            case 'AuxTrainingFinished'
                ...
                if isfield(TF, 'NN_Python')
                    ...
                    SS.NN_Python.TRAIN.socket = py.utah_client.UtahSocketClient();
                    SS.NN_Python.TRAIN.socket.connect("localhost", 54321);
                    SS.NN_Python.TRAIN.socket.start_control(z_size(1),x_size(1));
                end
