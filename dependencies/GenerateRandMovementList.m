function [outfile, MovementStruct]  = GenerateRandMovementList(outfile, NumTrials, DOF, FlexFlag, ComboFlag, Endpt, mDelay,  mVelocity, HoldTime, RandomizeOrder, RandomizeEndpt,RandomizeDelay, RandomizeVel, RandomizeHoldTime, RandomizeSpan, TrackingFlag)
