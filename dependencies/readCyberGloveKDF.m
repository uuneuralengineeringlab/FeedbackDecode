function [Kinematics,CyberGlove,Features,Targets,Kalman,NIPTime] = readCyberGloveKDF(fname)
...
CyberGlove = [];
if idxs(6,1)<=idxs(6,2)
    CyberGlove = Data(idxs(6,1):idxs(6,2),:);
end